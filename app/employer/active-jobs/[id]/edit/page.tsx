...
export default function EditJobPage() {
  ...
  useEffect(() => {
    const fetchJobDetails = async () => {
      try {
        ...
        const response = await axios.get(`https://techno-backend-a0s0.onrender.com/jobs/${jobId}`, {
          headers: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.put(`https://techno-backend-a0s0.onrender.com/jobs/${jobId}`, {
