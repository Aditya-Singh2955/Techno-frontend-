...
export const checkEmployerEligibility = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.get('https://technozis.up.railway.app/api/v1/employer/eligibility', {
        headers: {
...
export const submitJobPosting = createAsyncThunk(
  ...
  async (formData: JobFormData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post('https://technozis.up.railway.app/api/v1/create/jobs', {
